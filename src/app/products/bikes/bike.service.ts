...
export class BikeService {
    ...
    getBikes(): IBike[]{
		...
		},
		{
			...
			"image": {
				"thumb": "http://www.cube.eu/typo3temp/_processed_/csm_778500_overview_b9d262b44f.png",
				"large": "http://www.cube.eu/typo3temp/_processed_/csm_778500_light_412d6bd75b.jpg"
			},
		...
		},
		{
			...
			"image": {
				"thumb": "http://www.cube.eu/typo3temp/_processed_/csm_777400_overview_2bd8be2893.png",
				"large": "http://www.cube.eu/typo3temp/_processed_/csm_777400_light_112280f0d8.jpg"
			},
		...
		},
		{
			...
			"image": {
				"thumb": "http://www.cube.eu/typo3temp/_processed_/csm_776402_overview_afcdd3c64e.png",
				"large": "http://www.cube.eu/typo3temp/_processed_/csm_776402_light_24eb7350fe.jpg"
			},
			"class": ["comfort", "endurance"]
		},
		{
			...
			"image": {
				"thumb": "http://www.cube.eu/typo3temp/_processed_/csm_788400_overview_dbfa9bc7e6.png",
				"large": "http://www.cube.eu/typo3temp/_processed_/csm_788400_light_464e99b256.jpg"
			},
			"class": ["endurance", "race"]
		},
		{
			...
			"image": {
				"thumb": "http://www.cube.eu/typo3temp/_processed_/csm_750000_overview_d44dd92097.png",
				"large": "http://www.cube.eu/typo3temp/_processed_/csm_750000_light_b752848746.jpg"
			},
			"class": ["comfort"]
		}];
    }
